...
From the very beginning the issue of the market design was deemed to be crucial to insure that the wished for outcome came to fruition \cite{green1991reshaping}. However, the question of pricing for the electricity markets predates the privatization wave by many decades, a long running argument being that marginal cost pricing would not cover the investment costs of necessary but rarely used generation units \cite{boiteux1960peak}.\\
