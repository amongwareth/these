...
% ->want not to big bandwidth to avoid pushing estimates towards extremities (POI or +-3000€ point). -> 35 yields single-peaked second derivative
% 
...
% Source: INSEE:
%		
%		PRIX A L’IMPORTATION ET A L’EXPORTATION (SOURCE DOUANES), COURS INTERNATIONAUX
%		- On fournit les cours du pétrole et du gaz qui servent de référence sur le marché européen : le cours du pétrole brent daté (Moyenne mensuelle des cours de 
%		- ventes spot du baril de pétrole de type "brent" (issu de la Mer du Nord et servant de référence pour l'Europe) sur le marché de Londres.*** choisi) 
%		-  ainsi que le cours spot  , sur l'International Petroleum Exchange (IPE) à Londres, 
...
%		-On indique également le prix moyen (source Douanes) du charbon (*** choisi) 
%		- , du gaz (*** choisi) 
%		-  et du pétrole importés, 
%		- ainsi qu'une estimation du prix de l'électricité exportée.(*** choisi) 
%	
