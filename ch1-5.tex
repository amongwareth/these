...
The market is cleared by computing the intersection of the aggregate demand and ag- gregate supply functions, which are each obtained by summing up all individual bid functions for the demand and supply side of the market respectively. In a uniform pricing format, the determined equilibrium price is applied to all units sold in that auction.
...
market, and varies along different points of the bids.\\
...
The theoretical results of chapter 1 indicate that a key ingredient in explaining the dynamics on the electricity market is the uncertainty about demand shocks. \\

One key ingredient of this overall uncertainty present on the electricity market is the weather forecasts used by firms when they bid on the market. \\
